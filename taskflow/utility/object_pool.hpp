...
// Class: ObjectPool
//
// The class implements an efficient thread-safe object pool motivatedby the Hoard memory allocator algorithm.
// Different from the normal memory allocator, object pool allocatesonly one object at a time.
//
